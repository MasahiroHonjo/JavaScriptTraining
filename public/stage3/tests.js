...
describe('ステージ3（意図した通りに DOM 要素の構造を変更できるようになる）', function() {
  describe('DOMインターフェース編', function() {
    ...
    it('5 番の青色の要素の最初に要素を追加する', function() {
      ...
      // ここに記述してください。
      console.log(document.querySelector('blockquote').childNodes.length);
      console.log(document.querySelector('blockquote').childNodes[0]); 
  ...
  describe('jQuery 編', function() {
    ...
    it('10 番の青色の要素の最初に要素を追加する', function() {
      ...
      console.log(document.querySelector('p').childNodes[0]); 
